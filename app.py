...
def load_data_alunos():
  ...
  dados_ALUNOS = pd.concat([dados1_alunos, dados2_alunos, dados3_alunos, dados4_alunos, dados5_alunos, dados6_alunos, dados_alunos7, dados10_alunos, dados11_alunos, dados12_alunos, dados13_alunos])
