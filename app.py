...
def pagina_inicial(dados1, dados2):
  ...
  if(escolha == 'Estudantes'):
    estudantes(titulo, sobre, descricao1, descricao2, dados1)
  if(escolha == 'Professores'):
    professores(titulo, sobre, descricao1, descricao2, dados2)
...
def estudantes(titulo, sobre, descricao1, descricao2, dados1):
...
def professores(titulo, sobre, descricao1, descricao2, dados2):
