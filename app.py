...
def grafico_professores(escolha_IES, escolha_GRAFICOS, dados2):
  ...
  if(len(escolha_GRAFICOS) == 0):
    ...
    if('Cor/Raça' in escolha_GRAFICOS):
      ...
      y_feminino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1)]['TP_SEXO'].count())
      y_masculino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2)]['TP_SEXO'].count())
      y_feminino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1) & (dados2['TP_COR_RACA'] == 1)]['TP_COR_RACA'].count())
      y_masculino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2) & (dados2['TP_COR_RACA'] == 1)]['TP_COR_RACA'].count())
      y_feminino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1) & (dados2['TP_COR_RACA'] == 2)]['TP_COR_RACA'].count())
      y_masculino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2) & (dados2['TP_COR_RACA'] == 2)]['TP_COR_RACA'].count())
      y_feminino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1) & (dados2['TP_COR_RACA'] == 3)]['TP_COR_RACA'].count())
      y_masculino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2) & (dados2['TP_COR_RACA'] == 3)]['TP_COR_RACA'].count())
      y_feminino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1) & (dados2['TP_COR_RACA'] == 4)]['TP_COR_RACA'].count())
      y_masculino2.append(dados2[(dados2['CO_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2) & (dados2['TP_COR_RACA'] == 4)]['TP_COR_RACA'].count())
      y_feminino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1) & (dados2['TP_COR_RACA'] == 5)]['TP_COR_RACA'].count())
      y_masculino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2) & (dados2['TP_COR_RACA'] == 5)]['TP_COR_RACA'].count())
      y_feminino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1) & (dados2['TP_COR_RACA'] == 0)]['TP_COR_RACA'].count())
      y_masculino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2) & (dados2['TP_COR_RACA'] == 0)]['TP_COR_RACA'].count())
      y_feminino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1) & (dados2['TP_COR_RACA'] == 9)]['TP_COR_RACA'].count())
      y_masculino2.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2) & (dados2['TP_COR_RACA'] == 9)]['TP_COR_RACA'].count())
    ...
    if('Idades' in escolha_GRAFICOS):
      ...
      y_feminino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1)]['TP_SEXO'].count())
      y_masculino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2)]['TP_SEXO'].count())
      y_feminino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1) & (dados2['NU_IDADE'] <= 30)]['TP_SEXO'].count())
      y_masculino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2) & (dados2['NU_IDADE'] <= 30)]['TP_SEXO'].count())
      y_feminino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1) & (dados2['NU_IDADE'] >= 31) & (dados2['NU_IDADE'] <= 34)]['TP_SEXO'].count())
      y_masculino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2) & (dados2['NU_IDADE'] >= 31) & (dados2['NU_IDADE'] <= 34)]['TP_SEXO'].count())
      y_feminino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1) & (dados2['NU_IDADE'] >= 35) & (dados2['NU_IDADE'] <= 38)]['TP_SEXO'].count())
      y_masculino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2) & (dados2['NU_IDADE'] >= 35) & (dados2['NU_IDADE'] <= 38)]['TP_SEXO'].count())
      y_feminino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1) & (dados2['NU_IDADE'] >= 39) & (dados2['NU_IDADE'] <= 42)]['TP_SEXO'].count())
      y_masculino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2) & (dados2['NU_IDADE'] >= 39) & (dados2['NU_IDADE'] <= 42)]['TP_SEXO'].count())
      y_feminino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1) & (dados2['NU_IDADE'] >= 43) & (dados2['NU_IDADE'] <= 46)]['TP_SEXO'].count())
      y_masculino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2) & (dados2['NU_IDADE'] >= 43) & (dados2['NU_IDADE'] <= 46)]['TP_SEXO'].count())
      y_feminino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 1) & (dados2['NU_IDADE'] >= 47)]['TP_SEXO'].count())
      y_masculino3.append(dados2[(dados2['SG_IES'] == escolha_IES) & (dados2['TP_SEXO'] == 2) & (dados2['NU_IDADE'] >= 47)]['TP_SEXO'].count())
...
def pagina_inicial(dados1, dados2):
  ...
  descricao1 = st.markdown('O site realiza análises gráficas dos dados do Censo da Educação Superior de 2019, providos pelo Instituto Nacional de Estudos e Pesquisas Educacionais Anísio Teixeira, comparando a quantidade de estudantes e professores entre homens e mulheres presentes nos cursos e instituições de ensino superior do Brasil.')
  ...
  if(escolha == 'Estudantes'):
    estudantes(titulo, espaco, sobre, descricao1, descricao2, dados1)
  if(escolha == 'Professores'):
    professores(titulo, espaco, sobre, descricao1, descricao2, dados2)
...
def estudantes(titulo, espaco, sobre, descricao1, descricao2, dados1):
...
def load_data_alunos():
  ...
  dados_ALUNOS = pd.concat([dados1_alunos, dados2_alunos, dados3_alunos, dados4_alunos, dados5_alunos, dados6_alunos, dados7_alunos, dados10_alunos, dados11_alunos, dados12_alunos, dados13_alunos])
